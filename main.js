...
btnStart.addEventListener("click", () => {
    ...
    setTimeout(() => {
        ...
        if (cash <= 0) {
            aribtro.innerText = "🧙🏼‍♂️VOCÊ CAIU NA MAIOR ARMADILHA DOS GNOMOS!!!🧙🏽‍♂️\n🧙🏽‍♂️AGORA VOCÊ DEVE SUA VIDA A ELES!!!🧙🏿‍♂️\n🧙🏼‍♂️VOCÊ NUNCA CONSEGUIRA PAGAR A IMENSA DIVIDA QUE VOCÊ POSSUI!!!s🧙🏼‍♂️\n🧙🏻MUAHAHAHAHAHAHAHAHAHA!!!🧙🏿‍♂️";
            output.style.display = "none"
            btnDisplay.style.display = "none"
            proximo.style.display = "none"
